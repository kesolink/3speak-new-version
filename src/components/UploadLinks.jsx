...
export default function UploadLinks({ linkClass, iconClass = "icon", onClick }) {
  ...
  return (
    <>
      <Link to="/studio" className={linkClass} title="Upload Video" onClick={onClick}>
        <IoCloudUploadSharp className={iconClass} /> <span>Upload Video</span>
      </Link>
      <Link to="/embed-studio?from=shorts" className={linkClass} title="Upload Short" onClick={onClick}>
